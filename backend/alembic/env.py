...
if db_target == "log":
    ...
    version_locations = str(_HERE / "versions" / "log")
    version_table_schema = None
else:
    target_metadata = MainBase.metadata
    database_url = settings.main_database_url
    version_locations = str(_HERE / "versions" / "main")
    version_table_schema = "app"

# ScriptDirectory читает version_locations из config, не из context.configure
